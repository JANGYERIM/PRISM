...
#SBATCH -w ariel-v2
#SBATCH -t 1-0
#SBATCH -o /nas2/data/dpfla3573/code/PRISM/logs/slurm-%A_RFDecoder_EVAL_MoscaleBase_modifiedCode.out
...
--model_ckpt_path "./checkpoints/RFDecoder_t2m_0724221600_RFDecoder_Base/checkpoints/Unet1DforFlowDecoder_best_195_0.168677.pth" \
--num_sample_steps 16 \
--seed 24
